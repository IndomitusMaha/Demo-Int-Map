...
# Form implementation generated from reading ui file 'GBK.ui'
#
...
"}")
        ...
        self.privetstvieButton.setGeometry(QtCore.QRect(10, 160, 171, 31))
...
"}")
        ...
        self.perviietazhButton.setGeometry(QtCore.QRect(10, 210, 171, 31))
...
"}")
        ...
        self.label.setStyleSheet("Background-image:url(:/MapsResize/images/MapsУмень/ГБК.jpg)")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/MapsResize/images/MapsУмень/ГБК.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ГБК"))
        self.privetstvieButton.setText(_translate("MainWindow", "Приветствие"))
        self.perviietazhButton.setText(_translate("MainWindow", "ГБК"))
