...
# Form implementation generated from reading ui file 'SZHR.ui'
#
...
"}")
        ...
        self.label.setStyleSheet("Background-image:url(:/MapsResize/images/MapsУмень/СЖР.jpg)")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/MapsResize/images/MapsУмень/СЖР.jpg"))
