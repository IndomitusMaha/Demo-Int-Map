...
# Form implementation generated from reading ui file 'SSR.ui'
#
...
"}")
        ...
        self.szhrButton.setGeometry(QtCore.QRect(10, 170, 171, 31))
...
"}")
        ...
        self.label.setStyleSheet("Background-image:url(:/MapsResize/images/MapsУмень/ССР.jpg)")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/MapsResize/images/MapsУмень/ССР.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ССР"))
        self.privetstvieButton.setText(_translate("MainWindow", "Приветствие"))
        self.szhrButton.setText(_translate("MainWindow", "ССР"))
