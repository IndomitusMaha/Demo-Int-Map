...
"}")
        ...
        """""
        self.imageLabel = QtWidgets.QLabel(self.centralwidget)
        self.imageLabel.setMinimumSize(QtCore.QSize(500, 300))
        self.imageLabel.setText("")
        self.imageLabel.setObjectName("imageLabel")
        self.imageLabel.setScaledContents(True)
        #self.imageLabel.setStyleSheet("Background-image:url(:/arrow right/images/ФотоКаратау/01.jpg)")
...
"}")
        ...
        self.previousImgButton.clicked.connect(self.prev_Image)
...
"}")
    ...
    def next_Image(self):
        ...
        if self.i == 2:
            ...
            self.imageLabel.setStyleSheet("Background-image:url(:/arrow right/images/ФотоКаратау/02.jpg)")
            self.imageLabel.setPixmap(QtGui.QPixmap(":/arrow right/images/ФотоКаратау/02.jpg)"))
            self.imageLabel.setScaledContents(True)
            self.verticalLayout_2.addWidget(self.imageLabel, 3, 0)
        if self.i == 3:
            self.imageLabel = QtWidgets.QLabel(self.centralwidget)
            ...
            self.imageLabel.setStyleSheet("Background-image:url(:/arrow right/images/ФотоКаратау/03.jpg)")
            self.imageLabel.setPixmap(QtGui.QPixmap(":/arrow right/images/ФотоКаратау/03.jpg)"))
            self.imageLabel.setScaledContents(True)
            self.verticalLayout_2.addWidget(self.imageLabel, 3, 0)
        if self.i == 4:
            self.imageLabel = QtWidgets.QLabel(self.centralwidget)
            ...
            self.imageLabel.setStyleSheet("Background-image:url(:/arrow right/images/ФотоКаратау/04.jpg)")
            self.imageLabel.setPixmap(QtGui.QPixmap(":/arrow right/images/ФотоКаратау/04.jpg)"))
            self.imageLabel.setScaledContents(True)
            self.verticalLayout_2.addWidget(self.imageLabel, 3, 0)
