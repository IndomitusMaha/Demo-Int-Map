...
# Form implementation generated from reading ui file 'TNS.ui'
#
...
"}")
        ...
        self.label.setStyleSheet("Background-image:url(:/MapsResize/images/MapsУмень/ТНС.jpg)")
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/MapsResize/images/MapsУмень/ТНС.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "ТНС"))
        self.privetstvieButton.setText(_translate("MainWindow", "Приветствие"))
        self.szhrButton.setText(_translate("MainWindow", "ТНС"))
